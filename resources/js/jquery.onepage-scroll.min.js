		...
		e.fn.swipeEvents=function(){
			return this.each(function(){
				function i(e){
					...
					if(i&&i.length){
						t=i[0].pageX;n=i[0].pageY;r.bind("touchmove",s)
						}}
						function s(e){
							var i=e.originalEvent.touches;
							if(i&&i.length){
								var o=t-i[0].pageX;var u=n-i[0].pageY;if(o>=50){
									r.trigger("swipeLeft")}
																...
																if(t){
																	...
																	if(e("body").hasClass("disabled-onepage-scroll")){
																		...
																		i.swipeEvents().bind("swipeDown",function(t){
																			...
																			i.moveUp()}).bind("swipeUp",function(t){
																				if(!e("body").hasClass("disabled-onepage-scroll"))t.preventDefault();
																				i.moveDown()});
																	...
																	function u(e,t){deltaOfInterest=t;
																	var n=(new Date).getTime();
																	if(n-lastAnimation<quietPeriod+r.animationTime){
																		e.preventDefault();return}if(deltaOfInterest<0){
																			i.moveDown()}else{i.moveUp()}lastAnimation=n}
																			...
																			e.fn.transformPage=function(t,n,r){
																				...
																				if(e("html").hasClass("ie8")){if(t.direction=="horizontal"){
																					...
																					e.fn.moveDown=function(){var t=e(this);
																					...
																					if(next.length<1){
																						if(r.loop==true){pos=0;next=e(r.sectionContainer+"[data-index='1']")
																							}
																						else{return}}else{pos=index*100*-1
																						}
